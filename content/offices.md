...
description: "Addresses, hours, phone numbers, and booking links for MUP, FINA, Porezna uprava, HZZO, and court offices in Zagreb, Split, and Rijeka."
layout: offices
sitemap:
  priority: 0.7
officeStrings:
  ...
  fina-zagreb:
    ...
    bookingNote: "Walk-in; no appointment needed for OIB pickup and simple inquiries."
    hours: "Mon–Fri 08:00–16:00"
    note: "OIB pickup (when issued by Porezna uprava), business registration (obrt, d.o.o.), financial statements. Bring original passport."
  porezna-zagreb:
